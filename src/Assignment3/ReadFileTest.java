...
public class ReadFileTest
{
    ...
    public void testTextOneSentence() {
        ...
        try {
            file = (List<Sentence>)Analyzer.readFile("test1.txt");
        }
        catch (Exception ex) {
    ...
    public void testScoreOneSentence() {
        List<Sentence> file = null;
        try {
            file = (List<Sentence>)Analyzer.readFile("test2.txt");
        }
        catch (Exception ex) {
    ...
    public void testMultipleSentencesPositiveScores() {
        List<Sentence> file = null;
        try {
            file = (List<Sentence>)Analyzer.readFile("test3.txt");
        }
        catch (Exception ex) {
    ...
    public void testMultipleSentencesNegativeScores() {
        List<Sentence> file = null;
        try {
            file = (List<Sentence>)Analyzer.readFile("test4.txt");
        }
        catch (Exception ex) {
